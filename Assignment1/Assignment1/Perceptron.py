...
np.savetxt("PER-DS1.csv", np.transpose([index_array, prediction_result]), delimiter=",", fmt="%2.2f")
...
np.savetxt("PER-DS2.csv", np.transpose([index_array, prediction_result]), delimiter=",", fmt="%2.2f")
